...
> Status: **v0.9.9 — 1.0 candidate.** Native Swift / SwiftUI. The spine (v0.1–0.3:
...
> folders, undo, a universal archive wrapper), and (v0.9.9) **batch-tag a multiselection**,
> **per-row rename overrides**, and a **non-blocking eject**.
