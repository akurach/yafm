...
> Status: **v0.9.4 — 1.0 candidate.** Native Swift / SwiftUI. The spine (v0.1–0.3:
...
> audit pass (perf · security · UX · design) and a **float-layout visual redesign**
> (floating sidebar/panes, unified chrome titlebar, Phosphor icons + IBM Plex fonts,
> accent-color picker). See [ROADMAP.md](ROADMAP.md) and [CHANGELOG.md](CHANGELOG.md).
